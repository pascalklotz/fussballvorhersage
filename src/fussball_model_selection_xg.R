...
dat_train$quality <- ifelse(round(dat_train$predictions) == round(y_train), 3, 0)
dat_train$quality[round(dat_train$predictions) != round(y_train) & sign(round(dat_train$predictions)) == sign(round(y_train))] <- 1
...
dat_test$quality <- ifelse(round(dat_test$predictions) == round(y_test), 3, 0)
dat_test$quality[round(dat_test$predictions) != round(y_test) & sign(round(dat_test$predictions)) == sign(round(y_test))] <- 1
